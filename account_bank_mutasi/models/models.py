...
class AccountJournal(models.Model):
	...
	def open_action(self):
		...
		if action_name == 'action_mutasi_list':
			...
			[action] = self.env.ref('account_bank_mutasi.%s' % action_name).read()
			action['context'] = ctx
...
class MutasiBank(models.Model):
	...
	saldo_awal 	  = fields.Float(string="Saldo Awal", compute="_total_balance")
	saldo_akhir   = fields.Float(string="Saldo Akhir", compute="_total_balance")
